  ...
  ({ className, children, ...props }, ref) => (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed left-1/2 top-4 z-50 grid w-[min(92vw,860px)] -translate-x-1/2 gap-4 overflow-hidden rounded-3xl border border-border bg-background p-0 shadow-2xl outline-none sm:top-1/2 sm:max-h-[calc(100dvh-3rem)] sm:-translate-y-1/2",
          className
        )}
        {...props}
      >
        <div className="relative max-h-[calc(100dvh-2rem)] overflow-y-auto p-6 sm:max-h-[calc(100dvh-3rem)]">
          {children}
